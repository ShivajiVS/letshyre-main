...
import { candidateProfile } from "@/services/employee.service";
    ...
    <div className="pp-wrapper">
      ...
      <div className="pp-card" style={{marginTop:"90px"}}>
        ...
        <div className="pp-grid">
          ...
          <div className="pp-item">🏢 {profile.present_or_last_working_company || "N/A"}</div>
          <div className="pp-item">✔ {profile.is_verified ? "Verified" : "Not Verified"}</div>
        </div>
      </div>
      ...
      <div className="pp-main">
        ...
        <div>
          ...
          <div className="pp-card">
            <h4>Salary</h4>
            ₹ {profile.current_ctc} → ₹ {profile.expected_ctc} LPA
          </div>
          ...
          <div className="pp-card">
            <h4>Documents</h4>
            {(profile.resume || profile.experience_letter || profile.resignation_letter) ? (
              <>
                {profile.resume && <a href={profile.resume}>Resume</a>}<br/>
                {profile.experience_letter && <a href={profile.experience_letter}>Experience</a>}<br/>
                {profile.resignation_letter && <a href={profile.resignation_letter}>Resignation</a>}
              </>
            ) : (
